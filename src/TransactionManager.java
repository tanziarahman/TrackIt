...
public class TransactionManager implements TransactionManagerInterface{
        ...
        public String getTransactionsSummary() {
                ...
                for (Transaction t : transactions) {
                        summary.append(PURPLE+"["+RESET).append(t.getTransactionID()) .append(PURPLE+"] Date: "+RESET).append(new SimpleDateFormat("yyyy-MM-dd").format(t.getDate()))
                                .append(PURPLE+", Category: "+RESET).append(StringFormatter.capitalizeFirstLetter(t.getCategory()))
                                .append(PURPLE+", Sub-Category: "+RESET).append(StringFormatter.capitalizeFirstLetter(t.getSubCategory()))
                                .append(PURPLE+", Amount: "+RESET).append(t.getAmount())
                                .append(PURPLE+", Description: " + RESET).append(t.getDescription()).append("\n");
                }
